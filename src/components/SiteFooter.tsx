  ...
  return (
    <footer className="bg-primary text-primary-foreground pt-16 lg:pt-20 pb-8">
      <div className="max-w-[1280px] mx-auto px-5 sm:px-8">
        ...
        <div className="hidden lg:grid grid-cols-1 lg:grid-cols-12 gap-x-10 gap-y-10 pb-10 lg:pb-14">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <a href="#" aria-label="TikTok" className="w-11 h-11 rounded-full border border-primary-foreground/35 flex items-center justify-center hover:bg-primary-foreground hover:text-primary transition-colors">
                <TikTokIcon className="w-[18px] h-[18px]" />
              </a>
              <a href="#" aria-label="YouTube" className="w-11 h-11 rounded-full border border-primary-foreground/35 flex items-center justify-center hover:bg-primary-foreground hover:text-primary transition-colors">
                <Youtube className="w-[18px] h-[18px]" />
              </a>
              <a href="#" aria-label="LinkedIn" className="w-11 h-11 rounded-full border border-primary-foreground/35 flex items-center justify-center hover:bg-primary-foreground hover:text-primary transition-colors">
          ...
          <div className="lg:col-span-5 lg:pl-4">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-5">
              <ul className="space-y-5">
                {productsCol1.map((l) => (
                  <li key={l.label}>
                    <a href={l.href} className="text-[16px] text-primary-foreground/90 hover:text-primary-foreground transition-colors">
                      {l.label}
                    </a>
                  </li>
                ))}
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="flex items-end gap-3">
                ...
                />
                <button type="submit" aria-label="Abone ol" className="shrink-0 w-11 h-11 rounded-full bg-primary-foreground text-primary flex items-center justify-center hover:scale-105 transition-transform">
        ...
        {/* MOBILE layout — yeniden sıralama */}
        <div className="lg:hidden flex flex-col gap-8 pb-6">
          ...
          {/* 2) Reglini Çiz — yüksekliği düşük */}
          <a
            href="#"
            className="group relative block overflow-hidden rounded-2xl bg-[hsl(252,70%,90%)] text-primary transition-colors border border-primary-foreground/10 aspect-[16/4.8]"
          >
            <img src={regliniCizBg} alt="" aria-hidden="true" className="absolute inset-0 w-full h-full object-cover opacity-90 pointer-events-none" />
          ...
          <div className="-mt-4">
            <MobileAccordion title="Ürünler">
              <ul className="flex flex-col">
                {allProducts.map((l) => (
                  <li key={l.label}>
                    <a href={l.href} className="block py-2.5 text-[15px] text-primary-foreground/90 hover:text-primary-foreground transition-colors">
                      {l.label}
                    </a>
                  </li>
                ))}
