        ...
        <div className="flex items-end justify-between gap-4 sm:gap-6 mb-5 lg:mb-8">
          ...
          >
            ...
            <img
              ...
              alt=""
              aria-hidden="true"
              className="lg:hidden pointer-events-none select-none absolute left-1/2 -translate-x-1/2 bottom-[-10%] sm:bottom-[-60%] w-[115%] h-auto z-10"
              loading="lazy"
            />
            <span className="relative sm:hidden">Tüm Paketler</span>
            <span className="relative hidden sm:inline">Kendine özel paket oluştur</span>
          </a>
        </div>
